...
import { data1 } from './data/nextdrones';
  ...
  return (
    <div>
      ...
      >
        ...
        <Nav.Item>
          <Nav.Link href="/drones" style={{ color: "blue", fontSize: "16px",textDecoration:"underline" }}>Drones & Cameras</Nav.Link>
        </Nav.Item>
        <Nav.Item>
          ...
          {filteredProducts.length > 0 ? (
            filteredProducts.map((product, index) => (
              <Col key={index} xs={12} sm={6} md={4} lg={3} className="mb-4">
                <Link to={`/drones/${product.id}`} className="card-link">
                <div className="card">
