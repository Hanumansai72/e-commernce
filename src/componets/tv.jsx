  ...
  return (
    <div>
      ...
      >
        ...
        <Nav.Item>
          <Nav.Link href="/tv" style={{ color: "blue", fontSize: "16px", position: "relative", left: "10%", textDecoration: "underline" }}>TV & Home Cinema</Nav.Link>
        </Nav.Item>
        <Nav.Item>
          <input 
            type='search' 
          ...
          <Row>
            {filteredProducts.length > 0 ? (
              filteredProducts.map((product, index) => (
                ...
                <Link to={`/tv/${product.id}`} className="card-link" style={{ textDecoration: "none" }}>
                  <div className="card">
